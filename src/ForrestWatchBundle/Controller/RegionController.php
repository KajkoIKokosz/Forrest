...
use ForrestWatchBundle\Entity\Region;
...
class RegionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $regions = $em->getRepository('ForrestWatchBundle:Region')->findAll();
    ...
    {
        $region = new Region();
        $form = $this->createForm('ForrestWatchBundle\Form\RegionType', $region);
    ...
    {
        $deleteForm = $this->createDeleteForm($region);
        $editForm = $this->createForm('ForrestWatchBundle\Form\RegionType', $region);
