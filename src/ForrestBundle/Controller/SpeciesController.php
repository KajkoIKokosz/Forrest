...
use ForrestBundle\Entity\Species;
...
class SpeciesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $species = $em->getRepository('ForrestBundle:Species')->findAll();
    ...
    {
        $species = new Species();
        $form = $this->createForm('ForrestBundle\Form\SpeciesType', $species);
    ...
    {
        $deleteForm = $this->createDeleteForm($species);
        $editForm = $this->createForm('ForrestBundle\Form\SpeciesType', $species);
